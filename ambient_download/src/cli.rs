...
pub fn build_cli() -> Command {
    Command::new(clap::crate_name!())
        ...
        .arg( // Config-file
            ...
            // .default_value("ambient_tools.toml")
        ...
        .subcommand(Command::new("weather")
            ...
            .arg( // End date
                Arg::new("start-date")
                    .value_name("DATE")
                    .help("The start date for the downloads, If nothing is entered, yesterday's date is used. Date format must be YYYY-MM-DD (ISO 8601).")
                    .num_args(..=1)
                    .action(clap::ArgAction::Set)
            )
            .arg( // Limit
            ...
            .arg(
                Arg::new("sleep-time")
                    ...
                    .long_help("The time to sleep between downloads. Default is 10 seconds if not specified. Must be 5-3600 seconds (1 hour). The more records you download, the longer you should sleep between downloads.")
                    .num_args(1)
                    .action(clap::ArgAction::Set)
        ...
        .subcommand(Command::new("timezone")
            ...
            .arg(
                Arg::new("datetime")
                    .value_name("DATETIME")
                    .help("Datetime to convert between UTC and local (YYYY-MM-DD HH:MM:SS).")
                    .num_args(..=1)
                    .action(clap::ArgAction::Set)
            )
        )
        .subcommand(Command::new("newconfig")
            ...
            .arg( // Config-file
                Arg::new("config-file")
                    ...
                    .long_help("The configuration file in TOML format to create. Default is 'ambient_tools.toml' if not specified.")
                    .num_args(..=1)
            )
        )
}
