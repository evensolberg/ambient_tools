...
/// // "{mac}-%Y-%m-%d.json" + "AA:BB:CC:DD:EE:FF" → "AA-BB-CC-DD-EE-FF-2024-05-01.json"
/// // "{station}-%Y-%m-%d.json" + station "roof" → "roof-2024-05-01.json"
/// // "{station}-%Y-%m-%d.json" + no station → "AA-BB-CC-DD-EE-FF-2024-05-01.json"
/// ```
